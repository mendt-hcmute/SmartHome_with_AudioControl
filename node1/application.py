...
broker = "4be2d2486f5d49378e37387b5ab071a2.s1.eu.hivemq.cloud"
port = 8883
topic = "test/topic"
...
input_file = "/input_data/input_audio.wav"
output_dir = "/preprocessed_files"
mfcc_file = "/preprocessed_files/input_audio.npy"
...
class AudioRecorderApp(QWidget):
    def __init__(self):
        ...
        self.client = WebSocketClient("ws://192.168.133.202:81")
